      ...
      >
         <v-row no-gutters align="center" justify="center">
            ...
            <v-col cols="6" style="padding: 6%">
               ...
               >
                  <v-row class="pa-md-4 mt-1 d-flex justify-space-around mb-6"> </v-row>
               ...
               .then(res => {
                  if (res.data.status == "OK") {
                     ...
                     Swal.fire({
                        ...
                        icon: "success",
                        html: '<p style="font-family:Roboto;">Usuario creado correctamente!</p>'
                     });
               ...
               .catch(error => {
                  ...
                  if (status == 424) {
                     Swal.fire({
                        title: '<p style="font-family:Roboto;">Error</p>',
                        icon: "error",
                        html: '<p style="font-family:Roboto;">Esta cuenta ya se encuentra registrada en la comunidad.</p>'
                     });
                  } /*if (status == 401) */ else {
                     Swal.fire({
                        title: '<p style="font-family:Roboto;">Error</p>',
