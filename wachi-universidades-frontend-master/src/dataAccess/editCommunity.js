...
export function GetDataCommunity() {
   let url = process.env.VUE_APP_API_URL + "api/community/" + process.env.VUE_APP_API_KEY_COMMUNITY;
   return axios.get(url);
}

export function GetSubscription() {
   let url = process.env.VUE_APP_API_URL + "api/billing/subscription/" + process.env.VUE_APP_API_KEY_COMMUNITY;
   console.log(url);
   return axios.get(url);
}
...
export function getCommunityProfile(data) {
   let url = process.env.VUE_APP_API_URL + "api/blueprint/profile/community/" + process.env.VUE_APP_API_KEY_COMMUNITY;
