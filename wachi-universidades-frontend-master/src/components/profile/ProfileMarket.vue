      ...
      <v-card flat :disabled="edit" class="mt-5 ">
         <v-row dense no-gutters justify="center">
            <v-col cols="8" sm="4" align-md="3" lg="4" style="margin-left:20px">
               <v-select v-if="sellerBD" :items="items" disabled label="¿Deseas ser vendedor?" outlined v-model="info.sellerString"></v-select>
               <v-select
                  v-else
                  :items="items"
         ...
         <v-row dense no-gutters justify="center" style="padding-bottom: 50px">
            <v-col cols="8" sm="4" align-md="3" lg="8" style="padding-top:0px">
               <v-checkbox v-model="info.acceptEULA" v-if="!sellerBD && info.sellerString == 'Sí'"
               ...
               <v-checkbox v-model="info.acceptEULA" v-if="!sellerBD && info.sellerString == 'No'" disabled :value="false"
                  ><template v-slot:label>
                     <div>
                        Aceptas los
                        <v-tooltip bottom>
