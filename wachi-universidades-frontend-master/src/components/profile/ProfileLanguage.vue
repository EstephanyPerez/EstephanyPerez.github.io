            ...
            <v-row>
               <v-col :cols="otherProfile != 'yes' ? 10 : 12">
                  <v-row dense no-gutters justify="center">
                     ...
                     <v-col cols="12" sm="4" align-md="3" lg="9" style="margin-left:20px"></v-col>
                  </v-row>

                  <v-row dense no-gutters justify="center">
                     <v-col cols="8" sm="4" align-md="3" lg="4" style="margin-left:20px">
                        <v-select
                           v-model="info[i - 1].writingLevel"
                           :items="levels"
...
export default {
   ...
   data() {
      return {
         rules: {
            languageRules: [v => !!v || "Ingrese el idioma"]
         },
