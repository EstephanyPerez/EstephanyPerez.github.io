<template>
   ...
   <v-main>
      <v-card v-if="!loading" id="cardColor" outlined tile color="#F6F6F6">
         <!-- Title -->
         <v-row v-if="multiCardConfig.title.text != ''" align="center" justify="center" class="row-margin">
         ...
         <!-- Paragraph -->
         <v-row align="center" v-if="multiCardConfig.description.text != ''" justify="center" class="row-margin">
...
export default {
   ...
   computed: {
      ...mapState(["multiCardConfig", "generalConfig", "c_editComponent1", "c_editComponent2", "c_editComponent3"]),
