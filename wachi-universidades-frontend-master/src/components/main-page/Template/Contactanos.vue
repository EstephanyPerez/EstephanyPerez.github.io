<template>
   <v-main :style="{ backgroundColor: secondaryColor }">
      <v-row no-gutters align="center" justify="center">
         <v-col class="hidden-md-and-down pa-0 ma-0 pt-0 pb-0" md="6" style="margin:auto">
            <v-btn color="green" fab absolute large dark top right @click="editComponent()" :style="{ top: '20px', right: '20px' }">
               <v-icon>mdi-pencil</v-icon>
            </v-btn>
            <v-img lazy-src="https://picsum.photos/id/11/10/6" :src="imageURL" alt="Imagen de la tarjeta" :style="{ height: '70vh' }">
         ...
         <v-col
            ...
            cols="8"
            style="
    margin-bottom: 1%; margin-top: 1%; margin-left:1%
"
         >
            <v-card elevation="0" shaped :style="{ maxHeight: '70vh', padding: '5%', marginRight: '5%' }">
               ...
               <v-card-text>
                  <v-row>
                     ...
                     <v-col cols="12">
                        <v-textarea disabled :maxlength="maxLength" label="Mensaje *" auto-grow v-model="message"></v-textarea>
                     </v-col>
...
export default {
   ...
   computed: {
      ...mapState(["generalConfig", "contactUsConfig", "c_editComponentContactUs", "urlContactImage"])
   },

   methods: {
      ...mapActions(["editComponentContactUs", "editComponent3", "editComponent1", "editComponent2", "updateContactImage", "updateContactImageURL"]),
      editComponent() {
