<template>
   <v-main>
      ...
      >
         <input v-if="!read_only" class="file-input" ref="fileInputLanding" type="file" @input="onSelectFile" :style="{ position: 'absolute' }" />

         <v-row>
            <v-col class="col" cols="4" style="align-self:center">
               <v-textarea
                  v-if="landingConfig.landingText.textAlign == 'flex-start' && landingConfig.landingText.visible"
                  class="title-input"
                  solo
                  auto-grow
                  filled
            ...
            <v-col cols="4" style="align-self:center">
               <v-textarea
                  v-if="landingConfig.landingText.textAlign == 'center' && landingConfig.landingText.visible"
                  class="title-input"
                  solo
                  auto-grow
                  filled
            ...
            <v-col cols="4" style="align-self:center">
               <v-textarea
                  v-if="landingConfig.landingText.textAlign == 'flex-end' && landingConfig.landingText.visible"
                  class="title-input"
                  solo
                  auto-grow
                  filled
...
export default {
   ...
   computed: {
      ...mapState(["landingConfig", "generalConfig", "c_editComponent1", "urlLandingImage"]),
   ...
   methods: {
      ...mapActions(["editComponent1", "editComponent2", "editComponent3", "editComponentContactUs", "updateLandingImageUrl", "updateLandingImage"]),
      ...
      editComponent() {
         ...
         if (this.c_editComponent1 == true) {
            ...
            this.landingConfig.landingText.visible ? this.editComponent1(true) : (this.visibleTextBool = !this.visibleTextBool);
      ...
      hexToRgbA(hex) {
         ...
         if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(hex)) {
            ...
            c = "0x" + c.join("");
            return "rgba(" + [(c >> 16) & 255, (c >> 8) & 255, c & 255].join(",") + "," + this.alpha + ")";
         }
