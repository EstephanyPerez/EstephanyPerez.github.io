<template>
   <div>
      <v-row justify="center">
         <v-dialog v-model="this.dialog" fullscreen hide-overlay transition="dialog-bottom-transition" @keydown.esc="showDialog(false)">
            <v-card tile>
               <v-toolbar
                  flat
                  dark
               ...
               >
                  ...
                  <v-toolbar-title>Personalización de la comunidad</v-toolbar-title>
                  <v-spacer></v-spacer>
                  <v-toolbar-items>
               ...
               <v-subheader style="padding:2%">Caracterícas generales de la comunidad</v-subheader>
               <v-container>
                  <v-row>
                     <v-col>
                        <h4 class="ma-2">Color primario</h4>
                        <v-color-picker v-model="mainColor" class="ma-2"></v-color-picker>
                        <h4 class="ma-2">Color de texto</h4>
                        <v-row class="bcont2">
                           <v-select v-model="color_texto" :items="items" dense style="max-width: 60%; padding-left: 2%"></v-select>
                        </v-row>
                     </v-col>
                     <v-col>
...
export default {
   ...
   methods: {
      ...mapActions(["showDialog", "changeColorTexto", "updateMainColor", "updateSecondaryColor", "updateImageLogo", "updateLogoImageURL"]),
      closeDialog() {
