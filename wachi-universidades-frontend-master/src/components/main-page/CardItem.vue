      ...
      <v-row class="row-card">
         <v-col>
            <v-card class="mx-auto my-v-card" color="transparent" max-width="400" elevation="0">
               <div :id="'image-card-text' + pos" :style="style_div_style_focus" v-if="dataCard.image != ''">
                  <v-img lazy-src="https://picsum.photos/id/11/10/6" :src="dataCard.image" alt="Imagen de la tarjeta" height="220" />
               </div>

               <!-- Title Card-->
               <v-row align="center" justify="center" v-if="dataCard.title != ''">
                  <v-col
               ...
               <!-- Body Text Card-->
               <v-row align="center" justify="center" v-if="dataCard.text != ''">
                  <v-col class="c2_card_body_text" align="center" justify="center" :id="'body-card-text' + pos" cols="11">
                     <v-textarea
                        solo
