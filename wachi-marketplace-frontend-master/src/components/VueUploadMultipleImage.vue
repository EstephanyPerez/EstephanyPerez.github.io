         ...
         <div v-else @dragover.prevent="onDragover">
            ...
            >
               ...
               >
                  ...
                  >
                     <span
                        class="image-primary display-flex align-items-center"
                     >
                        <svg
...
export default {
   ...
   props: {
      dragText: {
         type: String,
         default: "Arrastre imágenes aquí"
      },
      browseText: {
         type: String,
         default: "O agregue desde su ordenador"
      },
      primaryText: {
         type: String,
         default: ""
      ...
      deleteImage(currentIndex) {
         this.$emit(
            ...
            () => {
               ...
               if (
                  this.images[currentIndex].default === 1 &&
                  currentIndex !== 0
               ) {
   ...
   created() {
      this.images = [];
      this.images = this.dataImages; //cloneDeep(this.dataImages);
      //this.currentIndex = 0;
   }
};
</script>
