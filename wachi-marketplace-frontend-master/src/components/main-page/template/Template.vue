...
import University3 from "@/components/main-page/template/University3.vue";
import ContactUs from "@/components/main-page/template/Contactanos.vue";
import ComponentMarketplaceSearch from "@/components/main-page/template/ComponentMarketplaceSearch";
      ...
      updateMB() {
         ...
         try {
            ...
            Swal.fire({
               ...
               html:
                  '<p style="font-family:Roboto;">Se actualizo la comunidad satisfactoriamente</p>',
            ...
            Swal.fire({
               ...
               html:
                  '<p style="font-family:Roboto;">No se pudo actualizar la comunidad correctamente</p>'
            });
         }
      },
      createBlueprintJson() {
