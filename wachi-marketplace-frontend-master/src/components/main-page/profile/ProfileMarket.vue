                     ...
                     <div>
                        ...
                        <v-tooltip bottom>
                           <template v-slot:activator="{ on }">
                              <a
                                 target="_blank"
                                 href="https://assets-2flock.s3.amazonaws.com/static/T%C3%A9rminos+de+uso.pdf"
                                 @click.stop
                                 v-on="on"
                              >
                                 términos de uso
                        ...
                        <v-tooltip bottom>
                           <template v-slot:activator="{ on }">
                              <a
                                 target="_blank"
                                 href="https://assets-2flock.s3.amazonaws.com/static/Pol%C3%ADtica+de+privacidad.pdf"
                                 @click.stop
                                 v-on="on"
                              >
