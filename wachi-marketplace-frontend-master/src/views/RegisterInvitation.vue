...
export default {
   ...
   methods: {
      ...
      register() {
         if (this.data.email == null || this.data.email.trim() == "") {
            ...
            Swal.fire({
               ...
               icon: "error",
               html:
                  '<p style="font-family:Roboto;">Ingrese un correo válido</p>'
            });
            ...
            userDA
               ...
               .then(res => {
                  if (res.data.status == "CREATED") {
                     Swal.fire({
                        title:
                           '<p style="font-family:Roboto;">Usuario Registrado</p>',
                        icon: "success",
                        html:
                           '<p style="font-family:Roboto;">Usuario registrado de manera correcta.</p>'
                     });
                     ...
                     Swal.fire({
                        ...
                        icon: "error",
                        html:
                           '<p style="font-family:Roboto;">Error con el registro del usuario.</p>'
                     });
                  }
               })
               .catch(err => {
      ...
      setParameters() {
         ...
         this.data.activation_code = decodeURIComponent(
            this.data.activation_code
         );
      }
   },
