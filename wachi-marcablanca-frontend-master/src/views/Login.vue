         ...
         <v-row no-gutters align="center" justify="center">
            ...
            >
               ...
               >
                  ...
                  <!--Button> Ingresar con 2Flock</Button-->
                  <v-row class="py-3">
                     <v-btn
                        class="login-button white--text"
                        block
      ...
      return {
         ...
         rules: {
            emailRules: [
               ...
               v =>
                  v.length <= 50 || "Cantidad de caracteres debe ser menor a 50"
            ],
            nameRules: [
                     ...
                     userDA
                              ...
                              userDA
                                 ...
                                 .then(res => {
                                    if (res.data.status == "OK") {
                                       ...
                                       if (
                                          res.data.payload.profileImage != null
                                       ) {
                                          localStorage.setItem(
                                             "avatarURL",
                                       ...
                                       Swal.fire({
                                          ...
                                          icon: "error",
                                          html:
                                             '<p style="font-family:Roboto;">Error con la creación de perfil</p>'
                                       });
                                    }
                                 })
                                 .catch(function() {
                        ...
                        .catch(function(error) {
                           ...
                           Swal.fire({
                              ...
                              icon: "error",
                              html:
                                 '<p style="font-family:Roboto;">Error al iniciar sesión</p>'
                           });
                        });
                  })
                  .catch(err => {
         ...
         communityDA
            ...
            .then(res => {
               ...
               if (res.data.status.localeCompare("OK") == 0) {
                  ...
                  if (status.toString().toUpperCase() == "INACTIVE") {
                     this.statusPayment = false;
                  } else {
                     this.statusPayment = true;
                  }
