            ...
            <v-row align="center" justify="center">
               ...
               >
                  <div class="pa-md-10 mx-lg-auto" width="5px">
                     ...
                     <p>Ingresa la nueva contraseña para su usuario.</p>
      ...
      registerPassword() {
         ...
         if (this.confirmPassword != this.data.newPassword) {
            Swal.fire({
               ...
               icon: "error",
               html:
                  '<p style="font-family:Roboto;">Nueva contraseña y su confirmación no son iguales</p>'
            });
            return;
         }
         ...
         if (this.data.password == this.data.newPassword) {
            Swal.fire({
               ...
               icon: "error",
               html:
                  '<p style="font-family:Roboto;">La contraseña actual y la nueva contraseña son iguales</p>'
            });
            return;
         }
            ...
            .catch(function(error) {
               ...
               if (
                  ...
                  Swal.fire({
                     ...
                     icon: "error",
                     html:
                        '<p style="font-family:Roboto;">La contraseña actual que ha ingresado es incorrecta</p>'
                  });
                  return;
               } else {
                  Swal.fire({
                     ...
                     icon: "error",
                     html:
                        '<p style="font-family:Roboto;">Error con la conexión al servidor</p>'
                  });
               }
            });
      },
