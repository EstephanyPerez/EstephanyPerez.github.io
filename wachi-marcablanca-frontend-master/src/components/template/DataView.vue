                     ...
                     <v-card>
                        ...
                        <v-card-actions>
                           ...
                           <v-btn
                              ...
                              text
                              @click="[(dialog = false), updateGeneralData()]"
                           >
                              Aceptar
                           </v-btn>
                        </v-card-actions>
               ...
               if (res.data.status.localeCompare("OK") == 0) {
                  ...
                  userDA.getCommunityProfile().then(resCom => {
                     if (resCom.data.status.localeCompare("OK") == 0) {
                        ...
                        this.data.profile.academicDetails =
                           resCom.data.payload.academicDetails;
                        this.data.profile.voluntaryWork =
                           resCom.data.payload.voluntaryWork;
                        this.data.profile.teaching =
                           resCom.data.payload.teaching;
                        this.data.profile.achievement =
                           resCom.data.payload.achievement;
                        this.data.profile.language =
                           resCom.data.payload.language;
                        this.data.profile.location =
                           resCom.data.payload.location;
      ...
      updateGeneralData() {
         try {
            ...
            Swal.fire({
               icon: "success",
               title:
                  '<p style="font-family:Roboto;">Datos de comunidad actualizados</p>',
               html:
                  '<p style="font-family:Roboto;">Se actualizaron los datos de la comunidad satisfactoriamente</p>',
            ...
            Swal.fire({
               icon: "error",
               title:
                  '<p style="font-family:Roboto;">Error al actualizar los datos</p>',
               html:
                  '<p style="font-family:Roboto;">No se pudieron actualizar los datos de la comunidad correctamente</p>'
            });
         }
      },
      updateData() {
