                     ...
                     .then(res => {
                        ...
                        if (res.status == 200) {
                           ...
                           Swal.fire({
                              ...
                              html:
                                 '<p style="font-family:Roboto;">Se actualizo la plantilla del login correctamente</p>'
                           });
                        }
                     });
               }
            ...
            .catch(function() {
               if (status == "401") {
                  /*Swal.fire({
                     ...
                     title: '<p style="font-family:Roboto;">Error</p>',
                     html:
                        '<p style="font-family:Roboto;">La plantilla</p>'
                  });*/
                  console.debug("erro en la actualizacion de la plantilla");
               } else {
                  Swal.fire({
                     icon: "error",
                     title:
                        '<p style="font-family:Roboto;">Error al actualizar plantilla</p>',
                     html:
                        '<p style="font-family:Roboto;">No se pudo actualizar la plantilla del login</p>'
                  });
               }
            });
      },
