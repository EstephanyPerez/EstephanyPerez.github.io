            ...
            <div className= {styles.row}>
              ...
              <div className={styles.column}>
                ...
                <br/><br/>
                  ...
                  <tr><h2 className={styles.justifyText}>Hola, {this.props.location.state.data['personalInfo']['names']}<br/><br/>
                  ...
                  <div className='row' style={{marginLeft:4+'%'}}>
                    ...
                    <div className='col-sm-6 ' >
                      <button onClick={this.submitPrev} className= "buttonPrev" id="buttonNext">
                        ¿No son tus datos?
                      </button>
                    </div>
                  
                    <div className='col-sm-6'>       
                      <button onClick={this.submit} className="buttonNext">
                        Continuar
                      </button>
                    </div> 
                  </div>  
