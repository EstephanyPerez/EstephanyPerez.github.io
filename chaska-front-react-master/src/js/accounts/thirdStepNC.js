...
class RegisterTNC3 extends Component  {
  constructor(props) {
    super(props);
    this.state = {
      locals:{}
  ...
  submit = async ( typeAccount, abbrevAccount) => {
    ...
    principalDistrict = this.props.location.state.dataClient['contactInfo']['idDistrict'];
    ...
    this.props.history.push({
      pathname : '/QuestionsInformationNC',
      state :{        
        clientData: this.props.location.state.dataClient,
