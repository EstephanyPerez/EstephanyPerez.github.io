<template>
  <div class="app-container">
    ...
    <el-tabs type="border-card">
      <el-tab-pane label="Por roles">
        <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
          <el-table-column align="left" label="Rol" width="180">
            <template slot-scope="scope">
              {{ scope.row.name }}
            </template>
          </el-table-column>
          <el-table-column align="header-center" label="Descripción" width="500">
            <template slot-scope="scope">
      ...
      <el-tab-pane label="Por usuarios">
        Próximamente
      </el-tab-pane>
    </el-tabs>

    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'Edit Role':'New Role'">
      <el-form :model="role" label-width="140px" label-position="left">
        ...
        <el-form-item label="Menús habilitados">
          <el-tree
            ref="tree"
